...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Tambah Data Ayam</h2>

        <form action="{{ route('ayam.storeayam') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="umur" name="umur" min="0" value="0" required>
            </div>
            <div class="mb-3">
